...
Section "Install"
    ...
    IntFmt $0 "0x%08X" $0
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CheckNumber" "DisplayName" "CheckNumber v9.4"
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\CheckNumber" "DisplayVersion" "9.4"
