...
def draw():
    ...
    if drawing:
        window.after(25, draw)  # 每隔25ms抽取一次学号
...
# 抽取按钮
button = tk.Button(window, text="抽取", command=start_draw, height=3, width=10, activebackground="red", font=("Source Han Sans CN", 50), highlightbackground="red", highlightcolor="red")
